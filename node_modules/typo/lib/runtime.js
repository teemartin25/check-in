...
function run(_ref) {
  var tokens = _ref.tokens,
      ...
      directive_value_not_defined = _ref.directive_value_not_defined;
  ...
  return tokens.map(function (token) {
    ...
    var value = get_replacer_value(token.replacer, data, template, directive_value_not_defined);
      ...
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              value = get_replacer_value(token.replacer, data, template, directive_value_not_defined);
